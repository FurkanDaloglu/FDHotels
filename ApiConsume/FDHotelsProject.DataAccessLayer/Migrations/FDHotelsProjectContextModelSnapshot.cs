...
namespace FDHotelsProject.DataAccessLayer.Migrations
{
    ...
    partial class FDHotelsProjectContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FDHotelsProject.EntityLayer.Concrete.About", b =>
                {
            ...
            modelBuilder.Entity("FDHotelsProject.EntityLayer.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FDHotelsProject.EntityLayer.Concrete.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FDHotelsProject.EntityLayer.Concrete.Booking", b =>
                {
            ...
            modelBuilder.Entity("FDHotelsProject.EntityLayer.Concrete.Contact", b =>
                {
            ...
            modelBuilder.Entity("FDHotelsProject.EntityLayer.Concrete.Guest", b =>
                {
            ...
            modelBuilder.Entity("FDHotelsProject.EntityLayer.Concrete.MessageCategory", b =>
                {
                    b.Property<int>("MessageCategoryID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FDHotelsProject.EntityLayer.Concrete.SendMessage", b =>
                {
            ...
            modelBuilder.Entity("FDHotelsProject.EntityLayer.Concrete.WorkLocation", b =>
                {
                    b.Property<int>("WorkLocationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FDHotelsProject.EntityLayer.Concrete.AppUser", b =>
                {
                    b.HasOne("FDHotelsProject.EntityLayer.Concrete.WorkLocation", "WorkLocation")
                        .WithMany()
            ...
            modelBuilder.Entity("FDHotelsProject.EntityLayer.Concrete.Contact", b =>
                {
                    b.HasOne("FDHotelsProject.EntityLayer.Concrete.MessageCategory", null)
                        .WithMany("Contacts")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("FDHotelsProject.EntityLayer.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("FDHotelsProject.EntityLayer.Concrete.AppUser", null)
                        .WithMany()
