...
namespace FDHotelsProject.WebUI.ValidationRules.GuestValidationRules
{
    public class CreateGuestValidator:AbstractValidator<CreateGuestDto>
    {
        public CreateGuestValidator()
        {
            ...
            RuleFor(x => x.City).MaximumLength(30).WithMessage("Lütfen en fazla 30 karakter veri girişi yapınız.");
            RuleFor(x => x.City).MaximumLength(20).WithMessage("Lütfen en fazla 20 karakter veri girişi yapınız.");
        }
    }
}
